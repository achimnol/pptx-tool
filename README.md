...
(`--tmp-dir`), limited to 1 GiB in total (`--tmp-quota-mb`); the files of the oldest finished
requests are deleted to make room.  Give each server process its own directory.
